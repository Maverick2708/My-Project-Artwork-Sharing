...
using API_ArtworkSharingPlatform.ViewModels.PersonViewModels;
...
namespace API_ArtworkSharingPlatform.Controllers
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        public PeopleController(Artwork_SharingContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Person>> PostPerson(CreatePersonDTO person)
        {
          if (_context.People == null)
          {
              return Problem("Entity set 'Artwork_SharingContext.People'  is null.");
          }
